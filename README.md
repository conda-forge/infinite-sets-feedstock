...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/infinite-sets-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12619&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/infinite-sets-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `infinite-sets` can be installed with:

```
conda install infinite-sets
```

It is possible to list all of the versions of `infinite-sets` available on your platform with:
